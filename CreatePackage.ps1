...
dotnet publish IPBan.sln -f netcoreapp2.2 -o package/linux-x64 -c Release -r linux-x64
dotnet publish IPBan.sln -f netcoreapp2.2 -o package/win-x86 -c Release -r win-x86
